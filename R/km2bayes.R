...
#'
#' The tool relies on manual digitization via `SurvdigitizeR` and allows for:
#' \itemize{
  ...
  bslib::page_sidebar(
    ...
    sidebar = bslib::sidebar(
      ...
      shiny::conditionalPanel(
        ...
        shiny::fileInput("img_upload", "Upload KM Image", accept = c("image/png", "image/jpeg", ".jpg", ".png")),
